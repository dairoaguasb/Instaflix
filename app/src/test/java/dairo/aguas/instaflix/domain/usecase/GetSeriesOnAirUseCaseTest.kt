 ...
 */
class GetSeriesOnAirUseCaseTest {

    private lateinit var getSeriesOnAirUseCase: GetSeriesOnAirUseCase
    private val serieRepository = mockk<SerieRepository>(relaxed = true)

    @Before
    fun setup() {
        getSeriesOnAirUseCase = GetSeriesOnAirUseCase(serieRepository)
    }
    ...
    fun whenUseCaseIsCalledShouldReturnSeriesOnAir(): Unit = runBlocking {
        ...
        //given
        coEvery { serieRepository.getSeriesOnAir() } returns flowSeries

        //when
        val seriesResult = getSeriesOnAirUseCase.invoke()
    ...
    fun whenUseCaseIsCalledShouldReturnAnException(): Unit = runBlocking {
        ...
        //when
        val serieResult = getSeriesOnAirUseCase.invoke()
